...
export class LocalGameEngine {
  ...
  // nextArenaId) - identico sui due client, MAI trasmesso in rete (vedi webrtc/snapshot.ts).
  ...
  // svuotato ad ogni emitSnapshot(), vedi webrtc/snapshot.ts (GameSnapshot.killedIds).
  ...
  //simula in locale in modo identico (stesso seed) - vedi webrtc/snapshot.ts.
